    ...
    $("#todayButton").click( function()
        {
            ...
            objXMLHttpRequest.open('get', 'getDataToday', true);
...
{{-- <script type="text/javascript">
    var objXMLHttpRequest = new XMLHttpRequest(),token = document.querySelector('meta[name="csrf-token"]').content;
    ...
    objXMLHttpRequest.open('POST', 'getData', true);
    objXMLHttpRequest.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
    objXMLHttpRequest.setRequestHeader('X-CSRF-TOKEN', token); 
    //objXMLHttpRequest.setRequestHeader("Accept", "application/json");
